...
---------------------------
* [시작하기](#시작하기/server.js) 
* [환경구분](#환경구분/environments.js)  
* [민감정보 관리](#민감정보관리/.env)  
* [공통 메세지 관리](#공통메세지관리/systemMessage.js)  
* [Sequelize 객체](#models)  
* [DB 연결](#sync-database) 
...
---------------------------------
<p float="left">
  <img src="./img/img_001.JPG" width="864" height="398"/> 
 </p>  
 
1. Package.json에 `npm start`(서버실행명령어)를 실행하게 되면 위의 `server.js`가 실행된다.(Package.json에 세팅)  
2. `server.js` 코드를 보면 `app.js` 파일에서 node 서버를 구동하고 이후 config/environments.js에 존재하는 정보를 통해 접속한다.
<br/>
<br/>

환경구분/environments.js
---------------------------------
 <p float="left">
  <img src="./img/img_002.png" width="791" height="447"/> 
 </p>
